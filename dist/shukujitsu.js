...
function ensureFirstLine(line) {
    var obj = lineToObject(line);
    if (obj['BEGIN'] !== 'VCALENDAR') {
        throw new Error("first line is not VCALENDAR. ".concat(line));
    }
}
...
function lineToObject(line) {
    var _a;
    var pair = (line !== null && line !== void 0 ? line : '').split(':');
    var key = pair[0].split(';')[0];
    var value = pair[1];
